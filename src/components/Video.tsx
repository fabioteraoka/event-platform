...
export function Video({lessonSlug}: VideoProps) {
  ...
  const { lesson } = data;
  const {videoId, title, teacher, description } = lesson
  ...
  return (
    <div className="flex-1">
      ...
      <div className="p-8 max-w-[1100px] mx-auto">
        <div className="items-start block gap-16 md:flex">
        ...
        <div className="grid gap-8 mt-20 grid-colos-1 md:grid-cols-2">
